...
const DESCRIPTION = [
  <p>
    ...
    COSIA,
    <b> les cartes de couvertures du sol directement obtenues par intelligence artificielle</b>, et
    qui interviennent par exemple dans la fabrication de l’OCS-GE.
  </p>,
  <p>
    Ces données ne sont pas encore publiées sur les sites de l’IGN (à l’exception du Gers). Ce
    prototype fonctionne comme un outil de co-construction pour tester et valider les besoins et les
    usages possibles autour de ces cartes avant leur publication.
    <b>
      {" "}
  ...
  <p>
    Vous pouvez partager ce prototype à votre entourage professionnelle mais nous vous demandons de
    ne pas communiquer publiquement dessus.
  </p>,
];
